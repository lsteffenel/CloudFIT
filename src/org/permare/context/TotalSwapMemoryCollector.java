 ...
 * @author kirsch
 */
public class TotalSwapMemoryCollector extends AbstractOSCollector<Double> {

    public static String COLLECTOR_NAME = "Thing.Device.Memory.Swap.Total";
    public static String COLLECTOR_DESCR = "Total physical swap memory available (in Kb)";

    public TotalSwapMemoryCollector() {
    ...
    public List<Double> collect() {
        ...
        if (this.getBean() instanceof com.sun.management.OperatingSystemMXBean) {
            ...
            results.add(new Double(bean.getTotalSwapSpaceSize() / 1024));
        } else {
